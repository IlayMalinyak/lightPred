...
from src.models import CNN, CNN_B
...
if __name__ == '__main__':
    ...
    train_dataset = TimeSeriesDataset(data_folder, train_list, t_samples=1024)
    val_dataset = TimeSeriesDataset(data_folder, val_list, t_samples=1024)
